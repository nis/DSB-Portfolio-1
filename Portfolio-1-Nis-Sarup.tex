...
\begin{eqnarray}
	20 \cdot Log_{10}(\frac{1}{1+(\frac{1000}{3000})^{2\cdot 5}}) &=& -0,00074dB \nonumber \\
	20 \cdot Log_{10}(\frac{1}{1+(\frac{3000}{3000})^{2\cdot 5}}) &=& -3,0103dB \nonumber \\
	20 \cdot Log_{10}(\frac{1}{1+(\frac{10000}{3000})^{2\cdot 5}}) &=& -52,2879dB \nonumber \\
\end{eqnarray}
